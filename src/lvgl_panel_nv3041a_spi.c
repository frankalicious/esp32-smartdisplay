...
void lvgl_lcd_init()
{
    ...
    const spi_bus_config_t spi_bus_config = {
        ...
        .miso_io_num = NV3041A_SPI_BUS_MISO_IO_NUM,
        .sclk_io_num = NV3041A_SPI_BUS_SCLK_IO_NUM,
        .quadwp_io_num = NV3041A_SPI_BUS_QUADWP_IO_NUM,
        .quadhd_io_num = NV3041A_SPI_BUS_QUADHD_IO_NUM,
    ...
    const esp_lcd_panel_io_spi_config_t io_spi_config = {
        .cs_gpio_num = NV3041A_SPI_CONFIG_CS_GPIO_NUM,
        .dc_gpio_num = NV3041A_SPI_CONFIG_DC_GPIO_NUM,
        ...
        .flags = {
            .dc_as_cmd_phase = NV3041A_SPI_CONFIG_FLAGS_DC_AS_CMD_PHASE,
            .dc_low_on_data = NV3041A_SPI_CONFIG_FLAGS_DC_LOW_ON_DATA,
            .octal_mode = NV3041A_SPI_CONFIG_FLAGS_OCTAL_MODE,
            .lsb_first = NV3041A_SPI_CONFIG_FLAGS_LSB_FIRST}};
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_spi((esp_lcd_spi_bus_handle_t)NV3041A_SPI_HOST, &io_spi_config, &io_handle));

    // Create nv3041a panel handle
    const esp_lcd_panel_dev_config_t panel_dev_config = {
        .reset_gpio_num = NV3041A_DEV_CONFIG_RESET_GPIO_NUM,
